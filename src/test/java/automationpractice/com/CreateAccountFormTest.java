...
public class CreateAccountFormTest {
	...
	public void authenticationPageEmailField() {
		...
		createAccount.setCreateAccountEmailField("eduardo");
		createAccount.getCreateAccountBtn().click();
		...
		// Registered email
		createAccount.setCreateAccountEmailField("eduardo@email.com");
		createAccount.getCreateAccountBtn().click();

		Assert.assertTrue(createAccount.getEmailBeenRegistered().isDisplayed());

		// Correct email
		createAccount.setCreateAccountEmailField("email123@email.com");
		createAccount.getCreateAccountBtn().click();
	...
	public void personalInfoFields() {
		// With values
		createAccountForm.setCustomerFirstNameField("Erivaldo");
		createAccountForm.setCustomerLastNameField("Silva");
		createAccountForm.setCustomerEmailField("email123@email.com");
	...
	public void requiredFieldsInputFormat() throws Exception {
		// Wrong format
		createAccountForm.setCustomerEmailField("email@email");
